    ...
    while True:
        ...
        if lmlist:
            ...
            if per_val1 == 100 and per_val2 == 100:
                ...
                color = (0,0,255)
            cvzone.putTextRect(img,f'PushUps: {int(count)}',(211,35),2,2,colorT=(255,255,255),colorR=(255,0,0),border=3,colorB=())
            cvzone.putTextRect(img,f'Left Hand',(15,350+80),1.4,2,colorT=(255,255,255),colorR=(255,0,0),border=3,colorB=())
            cvzone.putTextRect(img,f'Right Hand',(495,350+80),1.4,2,colorT=(255,255,255),colorR=(255,0,0),border=3,colorB=())

        ctime = time.time()
        fps = 1/(ctime - ptime)
        ptime = ctime
        cvzone.putTextRect(img,f'FPS : {int(fps)}',(270,440),1.6,2,colorT=(255,255,255),colorR=(0,135,0),border=3,colorB=())
